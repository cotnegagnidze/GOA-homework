...
# print(int_to_strings([1, 2, 3]))
# print(greet_names(["Alice", "Bob"]))
# print(subtract_five([10, 15, 20]))
...
# print(remove_empty_strings(["hello", "", "world"]))
# print(positive_numbers([-1, 0, 1, 2]))
# print(names_starting_with_a(["Alice", "Bob", "Anna"]))
